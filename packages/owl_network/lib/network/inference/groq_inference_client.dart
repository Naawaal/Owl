// language: Dart, file: groq_inference_client.dart, target: Flutter / Owl MOBA HUD
import 'dart:async';
...
/// GroqCloud ultra-fast LPU inference client over `https://api.groq.com/openai/v1`.
/// The chat API is OpenAI-compatible with ultra-low latency response windows.
final class GroqInferenceClient extends BaseInferenceClient {
  GroqInferenceClient(super.api);
